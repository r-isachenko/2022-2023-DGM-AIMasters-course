#####################
# CREDITS: https://github.com/mseitzer/pytorch-fid
# AND https://github.com/w86763777/pytorch-gan-metrics
...
class InceptionV3(nn.Module):
    ...
    def __init__(self,
        ...
        assert len(self.output_blocks) == 1 # just for simplification
    ...
    def forward(self, x):
        ...
        for idx, block in enumerate(self.blocks):
            if idx < 4:
                ...
                x = block(x)                                # N x 1000
                # x = F.softmax(x, dim=1) # should be done by STUDENTS
